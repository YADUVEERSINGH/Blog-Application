...
//	get post by Id
	...
	public ResponseEntity<PostDto> getPostyId(@PathVariable Integer postId){
...
//	delete user by id
	...
	public ApiResponse deletePost(@PathVariable Integer postId) {
		...
		return new ApiResponse("Post is deleted succesfullt", true);
	}
...
//	search by query
	@GetMapping("/posts/search/query/{keywords}")
	public ResponseEntity<List<PostDto>> searchPostByTitleQuery(@PathVariable("keywords") String keywords){
		List<PostDto> results = this.postService.searchPosts(keywords);
		return new ResponseEntity<List<PostDto>>(results, HttpStatus.OK);	
	}
}
